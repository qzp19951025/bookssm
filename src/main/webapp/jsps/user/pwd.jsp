...
<body>
	...
	<div class="div1">
		<form action="<c:url value='/userAction'/>" method="post"
			target="_top" id="pwdForm">
			...
			<table>
				...
				<tr>
					<td align="right"></td>
					<td><img id="vCode" src="<c:url value='/vcode'/>" border="1" />
						<a id="repImg">看不清，换一张</a></td>
				</tr>
				<tr>
					<td align="right">验证码:</td>
					<td><input class="input" type="text" name="verifyCode"
						id="verifyCode" value="${user.verifyCode}" /></td>
	...
	<script type="text/javascript"
		src="<c:url value='/jsps/js/user/mypwd.js'/>"></script>
</body>
</html>
